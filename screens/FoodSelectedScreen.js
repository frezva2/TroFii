        ...
        <Card
          ...
          item.foodInfo.image === newImage ? (
            ...
            <TouchableOpacity
              ...
              style={{
                ...
                width: 50,
                height: 50,
                marginTop: item?.userPostId !== undefined ? -30 : 20,
                marginLeft: height / width > 1.5 ? width * 0.65 : width * 0.7,
                justifyContent: "center",
                alignItems: "center",
                elevation: 10,
          ...
          {item?.comments ? (
            <TouchableOpacity
              ...
              onPress={() => {
                const arr = Object.keys(item?.comments)
                  .map((key) => {
          ...
          <View
            ...
            <View
              ...
              <Card.Content style={{ marginTop: -5, marginLeft: -5 }}>
                <Title
                  style={{ fontSize: 14, fontFamily: "MontserratSemiBold" }}>
                  {item.foodInfo.food_name}
                </Title>
                <Paragraph
                  style={{
                ...
                <Text
                  ...
                  {item.foodInfo.price !== 0 ? item.foodInfo.price : null}
                </Text>
              </Card.Content>
            </View>
            <View
