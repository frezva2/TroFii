          ...
          <Drawer.Section style={styles.drawerSection}>
            ...
            <TouchableOpacity
              onPress={() => {
                ...
                let dateID =
                  ...
                  sec * 1000 +
                  milsec;
                props.navigation.navigate("MyUploadedTroFiiScreen", {
                  dateID: dateID,
                });
              }}>
              <View
            ...
            <TouchableOpacity
              onPress={() => {
                ...
                let dateID =
                  ...
                  sec * 1000 +
                  milsec;
                props.navigation.navigate("MyFavTroFiiScreen", {
                  dateID: dateID,
                });
              }}>
              <View
            ...
            <TouchableOpacity
              onPress={() => {
                ...
                props.navigation.navigate("MyPhotosScreen", {
                  cameFromDate: dateID,
                });
              }}>
              <View
            ...
            <TouchableOpacity
              onPress={() => {
                Linking.openURL(`https://trofii.net/contact`);
              }}>
              <View
                style={{
                  flexDirection: "row",
            ...
            <TouchableOpacity
              onPress={() => {
                Linking.openURL(`https://trofii.net/#faq`);
              }}>
              <View
                style={{
                  flexDirection: "row",
