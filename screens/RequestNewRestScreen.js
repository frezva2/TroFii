        ...
        .once("value", async (snapshot) => {
          if (snapshot.val() !== null) {
            if (
              ...
              props?.route?.params?.cameFrom === "Home"
            ) {
  ...
  const startPostPic = () => {
    ...
    if (currentUser !== null && currentUser !== undefined) {
      firebase
        ...
        .ref(`/users/`)
        .push({
          email: `@${newData.restName
            .toString()
            .replace(/\s/g, "")}${newData?.restAddress
            ?.split(",")[1]
            .toString()
            .replace(/\s/g, "")}`,
          restName: `${newData.restName} -${
            newData?.restAddress?.split(",")[1]
          }`,
          restAddress: `${newData.restAddress}`,
          restHours:
            newData.restAxiosData?.data?.result?.opening_hours?.weekday_text
              .toString()
              .replace(/,/g, "\n\n"),
          ...
          points: 0,
          restOrderWeb: "",
          restWebsite: newData.restWebsite.slice(
            newData.restWebsite.indexOf("://") + 3
          ),
          isRestActive: true,
          aroundRadius: 40234,
          boolToken: true,
            ...
            firebase
              ...
              .then(() => {
                firebase
                  ...
                  .push({
                    _geoloc: {
                      lat: newData.restAxiosData?.data?.result?.geometry
                        ?.location?.lat,
                      lng: newData.restAxiosData?.data?.result?.geometry
                        ?.location?.lng,
                    },
                    dateId: dateID,
                    ...
                    foodLocation: {
                      latitude:
                        newData.restAxiosData?.data?.result?.geometry?.location
                          ?.lat,
                      longitude:
                        newData.restAxiosData?.data?.result?.geometry?.location
                          ?.lng,
  ...
  return (
    <View style={styles.container}>
                ...
                <View>
                  <Text
                    style={{
                      fontFamily: "MontserratSemiBold",
                      fontSize: 14,
                      color: newData.isOpenNow
                        ? "#06C906"
                        : newData.isOpenNow == undefined
                        ? "#06C906"
                        : "#C90611",
                      marginRight: 5,
                      marginLeft: 0,
            ...
            <View style={{ marginTop: 10 }}>
                ...
                {newData.cardRestNumFollowers === 0 ? (
                  <View style={{ flexDirection: "row" }}>
                    ...
                    <Paragraph
                      ...
                      This Restaurant is Not Yet Available.
                    </Paragraph>
                  </View>
                ) : (
              ...
              <View
                ...
                <View>
                  <TouchableOpacity
                    onPress={() => {
                      Linking.openURL(`http://${newData.restOrderWeb}`);
                    }}>
                    <View style={{ flexDirection: "row" }}>
                      <FontAwesome
                        name="shopping-cart"
                ...
                <View>
                  <TouchableOpacity
                    onPress={() => {
                      goToLocation(newData.restAddress);
                    }}>
                    <View style={{ flexDirection: "row" }}>
                      <FontAwesome
                        name="map-marker"
              ...
              <View
                ...
                <View>
                  <TouchableOpacity
                    onPress={() => {
                      Linking.openURL(`http://${newData.restWebsite}`);
                    }}>
                    <View style={{ flexDirection: "row" }}>
      ...
      <Modal
        ...
        propagateSwipe
        onModalHide={() => {
          setData({ ...newData, noResultsReq: false });
        }}
        onModalShow={() => {
          setData({ ...newData, noResultsReq: true });
        }}
        ...
        <ScrollView style={{ backgroundColor: "white", borderRadius: 35 }}>
          <View style={{ alignItems: "center", justifyContent: "center" }}>
            ...
            <View>
              <Title
                ...
                {newData.itemName === "" ? "New Item" : newData.itemName}
              </Title>
            </View>
            <View
              style={{
              ...
              <View
                ...
                <TextInput
                  ...
                  theme={avatorTheme}
                  onChangeText={(text) => {
                    setData({ ...newData, itemName: text });
                  }}
                  onFocus={() => {
                    setData({ ...newData, isFirstNameFocused: true });
                  }}
                  onBlur={() => {
                ...
                <List.Section
                  ...
                  <List.Accordion
                    ...
                    onPress={() => {
                      setData({
                        ...newData,
                        toggleItemCat: !newData.toggleItemCat,
                      });
                    }}>
                    <TouchableOpacity
                      onPress={() => {
                        setData({ ...newData, newCatType: "Entrée" });
                      }}>
                      <List.Item
                        style={{
                    ...
                    <TouchableOpacity
                      style={{ marginTop: 0 }}
                      onPress={() => {
                        setData({ ...newData, newCatType: "Appetizer" });
                      }}>
                      <List.Item
                        style={{
                          backgroundColor: "white",
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        setData({ ...newData, newCatType: "Dessert" });
                      }}>
                      <List.Item
                        style={{
                          backgroundColor: "white",
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        setData({ ...newData, newCatType: "Drink" });
                      }}>
                      <List.Item
                        style={{
                          backgroundColor: "white",
          ...
          <TouchableOpacity
            ...
            <LinearGradient
              colors={
                newData.takenPicture === "" && newData.itemName === ""
