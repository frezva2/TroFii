...
const RestaurantInfoScreen = (props) => {
  ...
  useEffect(() => {
    let timerId = setTimeout(async () => {
      try {
        await isOpen(
          props.route.params.finalResults.restName,
                ...
                firebase
                  ...
                  .once("value", async (snapshot) => {
                    if (snapshot.val() !== null) {
                      if (
                        props?.route?.params?.compCameFrom ===
                        "RestaurantSearch"
                      ) {
                        if (
                          snapshot
                          ...
                          setData({
                            ...
                            cardRestNumFollowers:
                              props.route.params.finalResults.RestNumFollowers,
                            cardIcon: "heart",
                            isLiked: true,
                        ...
                        props?.route?.params?.compCameFrom === "RestMenu"
                      ) {
                        if (
                          snapshot
                            .val()
                          ...
                          setData({
                            ...
                            restAxiosData: newResponse,
                            cardRestNumFollowers:
                              props.route.params.cardRestNumFollowers,
                            cardIcon: "heart",
                            isLiked: true,
                            PrivacyPolicy: snap.val().PrivacyPolicy,
                            TermsConditions: snap.val().TermsConditions,
  ...
  const followingFunc = () => {
    ...
    if (currentUser !== null) {
      ...
      const restListRef = firebase
        .database()
        .ref(`/restsList/${props.route.params.finalResults.objectID}`);
              ...
              if (
                ...
                if (
                  ...
                  return setData({
                    ...
                    isLiked: true,
                    cardIcon: "heart",
                    cardRestNumFollowers: snapshot?.val()?.followerNum + 1,
                  });
                } else {
                  ListOfRests = snapFirst?.val()?.restsList;
        ...
        <Animatable.View
          ...
          <View
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                shareNow(
                  props.route.params.finalResults.restWebsite,
                  props.route.params.finalResults.restName
                );
              }}>
              <View>
                <FontAwesome name="share-alt" color={"#EE5B64"} size={30} />
              </View>
            </TouchableOpacity>
            <Text
              style={{
            ...
            <Paragraph
              ...
              {props.route.params.finalResults.restAddress}
            </Paragraph>
            ...
            {props.route.params.finalResults.restDesc.length !== 0 ? (
              <View style={{ flexDirection: "row" }}>
                ...
                <Paragraph
                  ...
                  {props.route.params.finalResults.restDesc}
                </Paragraph>
              </View>
            ) : null}
            <View style={{ marginTop: 10 }}>
              ...
              <View
                ...
                <View>
                  {newData.cardRestNumFollowers === 0 ? (
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        Linking.openURL(
                          `http://${props.route.params.finalResults.restOrderWeb}`
                        );
                      }}>
                      <View style={{ flexDirection: "row" }}>
                        <FontAwesome
                ...
                <View>
                  <TouchableOpacity
                    onPress={() => {
                      goToLocation(props.route.params.finalResults.restAddress);
                    }}>
                    <View style={{ flexDirection: "row" }}>
                      <FontAwesome
                        name="map-marker"
              ...
              <View
                ...
                <View>
                  <TouchableOpacity
                    onPress={() => {
                      Linking.openURL(
                        `http://${props.route.params.finalResults.restWebsite}`
                      );
                    }}>
                    <View style={{ flexDirection: "row" }}>
                ...
                <View>
                  <TouchableOpacity
                    onPress={() => {
                      callNow(props.route.params.finalResults.phoneNum);
                    }}>
                    <View style={{ flexDirection: "row" }}>
              ...
              <TouchableOpacity
                onPress={() => {
                  props.navigation.navigate("RestMenu", {
                    restaurantUid:
                      props.route.params.finalResults.restaurantUid,
