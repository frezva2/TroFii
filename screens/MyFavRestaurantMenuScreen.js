...
const MyFavRestaurantMenuScreen = ({ navigation , route }) => {
            ...
            <View style={{ flex: 1 }}>
              ...
              <View style={{ backgroundColor: 'white', alignItems: 'center', justifyContent: 'center' , borderRadius: 35 }}>
                ...
                <View style={{ marginTop: 5, justifyContent: 'center', alignItems: 'center', marginBottom: 15 }}>
                  <TouchableOpacity style={{ justifyContent: 'center', alignItems: 'center' }} onPress={() => { setData({ ...data, isSubmitImage: false });  }} >
                  ...
                  <Card elevation={10} style={{ width: width * 0.90, borderRadius: 15 }}>
                    <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                      <Card.Cover style={{ width: width * 0.90, borderTopLeftRadius: 15, borderTopRightRadius:15 }} source={{ uri: item.foodInfo.image === oldImage ? newImage : item.foodInfo.image }} />
                      {
                        ...
                        >
                          <View>
                            <Button style={{ backgroundColor: '#C90611', borderRadius: 10, marginTop: -30 }} >
                    ...
                    <View style={{ flexDirection: 'row', width: width * 0.75, justifyContent: 'flex-start' }}>
                      <View style={{ flexDirection: 'row', margin: 5, width: width * 0.60, marginTop: 15, marginRight: 10 }}>
                      ...
                      <View style={{ alignItems: 'flex-start', flexDirection: 'column', marginLeft: 0, justifyContent: 'flex-start' }}>
                        ...
                        <View style={{ alignItems: 'center', marginLeft: 5, flexDirection: 'row', marginTop: -20 }}>
                          <View>
...
export default MyFavRestaurantMenuScreen;