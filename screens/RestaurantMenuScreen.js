...
// import { Form, Select } from 'native-base';
        ...
        <View style={styles.container}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Configure 
              ...
              facetFilters= {['isRestActive:true', `restName:${route.params.restaurantName}`, `foodInfo.foodType:${data.foodType}`]}
            ...
            />
              <ScrollView>
                <View style={{  alignItems: 'center', justifyContent: 'center', marginTop: 10, width }}>
                <View>
                  <Searchbar
                    placeholder="Find restaurant "
                    // onIconPress={() => { handleSearch(searchQuery); }}
                  ...
                  {/* <SearchBox navigation={navigation}/> */}
                    ...
                    >
                        <TouchableOpacity style={{ marginLeft: 20, marginTop: 10 }} onPress={() => { setData({ ...data, activeButton: 'Recommended', sortBy: 'worests', foodType: '' }) }} >
                          <LinearGradient colors={data.activeButton === 'Recommended' ? ['#fb8389', '#f70814', '#C90611'] : ['white', 'white', 'white'] } style={styles.linearGradient3}>
                            <Text style={{
                              fontSize: 13,
                              ...
                              marginLeft: 20,
                              marginRight: 20,
                              color: data.activeButton === 'Recommended' ? '#ffffff' : 'black',
                              backgroundColor: 'transparent'}}>
                                Recommended
                            </Text>
                          </LinearGradient>
                        </TouchableOpacity>
                        <TouchableOpacity style={{ marginLeft: 20, marginTop: 10 }} onPress={() => { setData({ ...data, activeButton: 'Popular', sortBy: 'sortByTotalView', foodType: '' }) }} >
                          <LinearGradient colors={data.activeButton === 'Popular' ? ['#fb8389', '#f70814', '#C90611'] : ['white', 'white', 'white'] } style={styles.linearGradient3}>
                              <Text style={{
                                fontSize: 13,
                                fontFamily: 'MontserratBold',
                                textAlign: 'center',
                                ...
                                marginLeft: 20,
                                marginRight: 20,
                                color: data.activeButton === 'Popular' ? '#ffffff' : 'black',
                                backgroundColor: 'transparent'}}>
                                  Popular
                              </Text>
                          </LinearGradient>
                        </TouchableOpacity>
                        <TouchableOpacity style={{ marginLeft: 20, marginTop: 10 }} onPress={() => { setData({ ...data, activeButton: 'Starters', sortBy: 'foodsList', foodType: 'Appetizer' }) }} >
                          <LinearGradient colors={data.activeButton === 'Starters' ? ['#fb8389', '#f70814', '#C90611'] : ['white', 'white', 'white'] } style={styles.linearGradient3}>
                            <Text style={{
                                  fontSize: 13,
                                  fontFamily: 'MontserratBold',
                                  textAlign: 'center',
                                  ...
                                  marginLeft: 20,
                                  marginRight: 20,
                                  color: data.activeButton === 'Starters' ? '#ffffff' : 'black',
                                  backgroundColor: 'transparent'}}>
                                    Starters
                                </Text>
                          </LinearGradient>
                        </TouchableOpacity>
                        <TouchableOpacity style={{ marginLeft: 20, marginTop: 10 }} onPress={() => { setData({ ...data, activeButton: 'Entrées', sortBy: 'foodsList', foodType: 'Entrée' }) }} >
                          <LinearGradient colors={data.activeButton === 'Entrées' ? ['#fb8389', '#f70814', '#C90611'] : ['white', 'white', 'white'] } style={styles.linearGradient3}>
                            <Text style={{
                                    fontSize: 13,
                                    fontFamily: 'MontserratBold',
                                    textAlign: 'center',
                                    ...
                                    marginLeft: 20,
                                    marginRight: 20,
                                    color: data.activeButton === 'Entrées' ? '#ffffff' : 'black',
                                    backgroundColor: 'transparent'}}>
                                      Entrées
                            </Text>
                          </LinearGradient>
                        </TouchableOpacity>
                        <TouchableOpacity style={{ marginLeft: 20, marginTop: 10 }} onPress={() => { setData({ ...data, activeButton: 'Desserts', sortBy: 'foodsList', foodType: 'Dessert' }) }} >
                          <LinearGradient colors={data.activeButton === 'Desserts' ? ['#fb8389', '#f70814', '#C90611'] : ['white', 'white', 'white'] } style={styles.linearGradient3}>
                            <Text style={{
                                    fontSize: 13,
                                    fontFamily: 'MontserratBold',
                                    textAlign: 'center',
                                    ...
                                    marginLeft: 20,
                                    marginRight: 20,
                                    color: data.activeButton === 'Desserts' ? '#ffffff' : 'black',
                                    backgroundColor: 'transparent'}}>
                                      Desserts
                            </Text>
                          </LinearGradient>
                        </TouchableOpacity>
                        <TouchableOpacity style={{ marginLeft: 20, marginTop: 10, marginRight: 25 }} onPress={() => { setData({ ...data, activeButton: 'Drinks', sortBy: 'foodsList', foodType: 'Drink' }) }} >
                          <LinearGradient colors={data.activeButton === 'Drinks' ? ['#fb8389', '#f70814', '#C90611'] : ['white', 'white', 'white'] } style={styles.linearGradient3}>
                            <Text style={{
                                    fontSize: 13,
                                    fontFamily: 'MontserratBold',
                                    textAlign: 'center',
                                    ...
                                    marginLeft: 20,
                                    marginRight: 20,
                                    color: data.activeButton === 'Drinks' ? '#ffffff' : 'black',
                                    backgroundColor: 'transparent'}}>
                                      Drinks
                            </Text>
                          </LinearGradient>
            ...
            <View style={{ flex: 1 }}>
              <Modal  
                ...
                onBackdropPress={() => { setData({ ...data, isSubmitImage: false }); }} 
                backdropColor='black'
        ...
        <View style={{ flex: 1, marginBottom: 20, marginTop: 10}}>
          <FlatList
            ...
            renderItem={({ item, index }) => {        
              return (
                <View style={{ justifyContent: 'flex-start', alignItems: 'flex-start', marginRight: (hits.length - 1) === index ? 100 : 15 , marginLeft: index === 0 ? 15 : 0, marginBottom: 25 }}>
                  <Card elevation={10} style={{ width: width * 0.75, borderRadius: 15 }}>
                    <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                      <Card.Cover style={{ width: width * 0.75, borderTopLeftRadius: 15, borderTopRightRadius:15 }} source={{ uri: item.foodInfo.image === oldImage ? newImage : item.foodInfo.image }} />
                      {
                        item.foodInfo.image === oldImage ?
                          ...
                          onPress={() => {
                            searchState = Object.assign({ ...searchState, takenPicture: '' }); 
                            navigation.navigate('RestMenu', { isSubmitImage: true, food_name: item.foodInfo.food_name, hits: hits, activeSlide: index });
                          }} 
                        >
                          <View>
                    ...
                    <View style={{ flexDirection: 'row', width: width * 0.75, justifyContent: 'flex-start' }}>
                      <View style={{ flexDirection: 'row', margin: 5, width: width * 0.40, marginTop: 15, marginRight: 10 }}>
                      ...
                      <View style={{ alignItems: 'flex-start', flexDirection: 'row', marginLeft: -45, justifyContent: 'flex-start' }}>
                        {
