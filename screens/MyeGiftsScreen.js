        ...
        firebase
          ...
          .once("value", (snapshot) => {
            if (snapshot.val() !== null) {
              ...
              setData({ ...data, uid: currentUser.uid, myeGifts: arr });
            }
          });
      }
    }, 10);
        ...
        <View
          ...
          <View style={{ flex: 1 }}>
            <Image
              ...
              source={{
                uri:
                  item.egiftChoice === "grub"
                    ? grubUri
                    : item.egiftChoice === "door"
                    ? dashUri
                    : uberUri,
              }}
            />
          ...
          <View
            ...
            <View
              ...
              <Image
                ...
                source={{
                  uri: item.iseGiftRequestApproved ? approvedUri : pendingUri,
                }}
              />
            </View>
            ...
            <Text style={styles.titleStyle5}>ID: {item.uniqID}</Text>
          </View>
          <View
            style={{
              flex: 1,
            ...
            <Caption style={styles.titleStyle4}>Earned</Caption>
            <Text style={styles.titleStyle2}>${item.egiftEarned}</Text>
          </View>
        </View>
      </View>
    );
    ...
    <SafeAreaView style={{ flex: 1 }}>
      <View style={{ flex: 1, marginTop: Platform.OS === "ios" ? -10 : 0 }}>
        ...
        <View
          ...
          <Text style={styles.titleStyle7}>My eGifts</Text>
        </View>
        <View
          style={{
            height: 1,
...
const styles = {
  titleStyle7: {
    ...
    fontSize: 14,
    marginLeft: height / width > 1.5 ? width * 0.3 - 20 : width * 0.4 - 20,
    justifyContent: "center",
  },
  titleStyle6: {
