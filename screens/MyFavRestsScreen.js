                ...
                if (snapshot !== 0) {
                  firebase
                    ...
                    .once("value", (snap2) => {
                      snap2.forEach((data1) => {
                        if (
                          data1.val().restaurantUid === snapshot &&
                          data1.val().isRestActive
                        ) {
            ...
            <View style={{ flexDirection: "row", width: width * 0.7 }}>
              <View
                ...
                <View
                  ...
                  <Text style={styles.titleStyle}>{item.restName}</Text>
                </View>
                <View
                  style={{
                    flex: 1,
              ...
              <View style={{ marginLeft: 5, marginTop: 10, marginLeft: 0 }}>
                <Text style={{ fontFamily: "MontserratBold", fontSize: 10 }}>
                  {item.RestNumFollowers}{" "}
                  {item.RestNumFollowers === 1 ? "Follower" : "Followers"}
                </Text>
              </View>
            </View>
          </View>
